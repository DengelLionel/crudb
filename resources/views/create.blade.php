...
<div class="flex min-h-[50px]  bg-gray-100 font-sans">
  ...
  <input placeholder="escribe name" type="text"name="name">
  <input placeholder="escribe presentation"  type="text" name="presentation">
  <input placeholder="escribe puv" type="text" name="puv">
  <input placeholder="escribe puc" type="text" name="puc">
